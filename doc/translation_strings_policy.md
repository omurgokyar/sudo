...
This document provides guidelines for internationalization of the Sudo Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sudo_en.ts` remains unchanged.
