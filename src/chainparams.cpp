...
public:
    CMainParams() {
        ...
        consensus.nBudgetPaymentsStartBlock = 300000000; //Disable Budget Payment
        consensus.nBudgetPaymentsCycleBlocks = 14600; // 175200/12
        consensus.nBudgetPaymentsWindowBlocks = 100;
        consensus.nSuperblockStartBlock =300000000; //Disable Super Block
        ...
        consensus.nMinimumChainWork = uint256S("0000000000000000000000000000000000000000000000000000000002800280");//39
        ...
        vSporkAddresses = {"SMq8rQjrRujNumPx4vsKEg54SbXGgeD64z"};
        nMinSporkKeys = 1;
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 170, uint256S("0x0000005f9925ea6ba014cf3c03414902d6b8c47b51660c9d0e2d211746807e41"))
            ( 1975, uint256S("0x00000014f4154dab4c259e4c4d4ccd689fa14890f3db182cce363820ba12ca68"))
            ( 2018, uint256S("0x00000008db0a443b56ede645d02a2ae6ba2b198712861d5b84fc07edeca67bd7"))
            ( 3172, uint256S("0x00000001c26fcdc0ed02a600e78e0764938fe7c837bb09266d51edef91b6b57f"))
            ( 3266, uint256S("0x00000003fe0cfb661e28651e1e14cfd70634c970a0581dc0867a0beea9ca479d"))
            ( 13013, uint256S("0x000000000004f2c19628385e246fb7a0d9d525559855d999dcc0cac2ef8bce5d"))
            ( 18000, uint256S("0x00000000013d41b493a4fe69e1072ba9a210e6b120a148d89855d11ec42b5fc5"))
            ( 24000, uint256S("0x00000000006652f74fac21fc876b86d7acd64aed713cea2d2c6ffb85f8e7c630"))
            ( 27000, uint256S("0x0000000000f0fd9bd93669a5b2c2a285441461f0e9f55820a82b62e5590a239c"))
            ( 30000, uint256S("0x00000000039620191e907bde447ee609004b5053edcedafe39600a579ffce801"))
            ( 32000, uint256S("0x0000000002cf46a3bb6b36f599f6bc181c9745c4d4f64827204b0ab3bf43b044"))
            ( 34000, uint256S("0x0000000000982afa0cf77e9dec9349c94e62910b4262287b06be96f99639255f"))
            ( 35000, uint256S("0x00000000021ec461492cfd8514a0cdd9a5393be2b28ce91096271856a582f714"))
            ( 39000, uint256S("0x0000000000e295b9b83d59f131d058ca6e40967171067803f2b9ceaf94cb01c3"))
            ( 42000, uint256S("0x0000000003423bcafcc62af497ec11c46dd2ac4a3c9bf7de81650c4b1f66be5d"))
            ( 42500, uint256S("0x0000000002d78c25968be6f5afe35d5d762d0d28c93d2cd42e539eba0709d6d6"))
        };
...
public:
    CTestNetParams() {
        ...
        vSporkAddresses = {"sbejCFGH18NLwqUHDktACtGrBU6hasffZx"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;
...
public:
    CRegTestParams() {
        ...
        vSporkAddresses = {"rPxNGUsRh5jJStccZ6kzFrxihrvrC1nvGB"};
        nMinSporkKeys = 1;
