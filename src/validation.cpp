                              ...
                              const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool fDryRun)
{
    ...
    BOOST_FOREACH(const CTxIn &txin, tx.vin)
    {
        ...
        if (itConflicting != pool.mapNextTx.end())
        {
            ...
            // Transaction conflicts with mempool and RBF doesn't exist in Sudo
...
CAmount GetBlockSubsidy(int nPrevBits, int nPrevHeight, const Consensus::Params& consensusParams, bool fSuperblockPartOnly)
{
    ...
    if ((nPrevHeight > 7200) && (nPrevHeight <= 8640)) {nSubsidyBase = 30;} // Between 7200 & 8641 blocks, reward is 30 SUDO
    if ((nPrevHeight > 8640) && (nPrevHeight <= 23039)) {nSubsidyBase = 9;} // Between 8641 & 23040 blocks, reward is 9 SUDO - 1 Month
    if ((nPrevHeight > 23039) && (nPrevHeight <= 80639)) {nSubsidyBase = 90;} // Between 23040 & 80640 blocks, reward is 90 SUDO - 4 Months
    if ((nPrevHeight > 80639) && (nPrevHeight <= 138239)) {nSubsidyBase = 75;} // Between 80640 & 138240 blocks, reward is 75 SUDO - 4 Months
    if ((nPrevHeight > 138239) && (nPrevHeight <= 195839)) {nSubsidyBase = 60;} // Between 138240 & 195840 blocks, reward is 60 SUDO - 4 Months
    if ((nPrevHeight > 195839) && (nPrevHeight <= 282239)) {nSubsidyBase = 45;} // Between 195840 & 282240 blocks, reward is 45 SUDO - 6 Months
    if (nPrevHeight > 282239) {nSubsidyBase = 30;} // After 282240. blocks, reward is 30 SUDO
...
{
    CAmount ret = (blockValue/100)*70; // MN Reward Start at 70%

    int nMNPIBlock = Params().GetConsensus().nMasternodePaymentsIncreaseBlock;
    if(nHeight > nMNPIBlock) ret = (blockValue/100)*60; // After block number 14400 - MN Reward: %60
    return ret;
}
